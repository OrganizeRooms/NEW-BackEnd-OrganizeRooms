 ...
 */
package br.com.organizerooms.error;
...
//	@ExceptionHandler()
//	public ResponseEntity<?> dataIntegrity( HttpServletRequest request) {
//		
//		//StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Integridade de dados", e.getMessage(), request.getRequestURI());
//		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("jhjj");
//	};
...
//	@ExceptionHandler()
//	public ResponseEntity<?> authorization(HttpServletRequest request) {
//		
//		//StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.FORBIDDEN.value(), "Acesso negado", e.getMessage(), request.getRequestURI());
//		return ResponseEntity.status(HttpStatus.FORBIDDEN).body("dberher");
//	};
